...
internal sealed record WorkspaceSwitchResult(
    ...
    TimeSpan CloseReconciliationDuration = default);
...
internal sealed class WorkspaceSwitchEngine : IAsyncDisposable
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        bool entered = false;
        Stopwatch reconciliationTimer = Stopwatch.StartNew();
        try
        {
            ...
            int riskCount = _windows.InspectUserWindows(
                ...
                .Count(window => !keep.Contains(window.Hwnd));
            ...
            if (requested.Count > 0)
            {
                ...
                if (finalRemaining.Length > 0)
                {
                    return new WorkspaceSwitchResult(
                        ...
                        requested.Count,
                        finalRemaining,
                        CloseReconciliationDuration: reconciliationTimer.Elapsed);
                }
            }
