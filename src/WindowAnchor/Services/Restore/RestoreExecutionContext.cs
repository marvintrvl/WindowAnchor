...
internal sealed class RestoreExecutionContext
{
    internal RestoreExecutionContext(RestorePlan plan)
    {
        ...
        Timing.AddPriorStage(
            ...
            plan.ObservationPlanningDuration);
        Timing.AddPriorStage(
            RestoreProgressStage.PreparingPreview,
            plan.PreviewPreparationDuration);
...
internal static class RestoreExecutionSupport
{
    ...
    {
        string explanation = MarkEntryStale(state, reason);
    ...
    internal static string MarkEntryStale(
        RestoreEntryExecutionState state,
        RestorePlanStaleReason reason)
    {
