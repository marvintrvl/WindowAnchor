...
public sealed record RestorePlan
{
    ...
    public string? LayoutVariantId { get; init; }
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
    public string? LayoutVariantName { get; init; }
    ...
    /// <summary>Read-only observation and planning work completed before this plan was returned.</summary>
    internal TimeSpan ObservationPlanningDuration { get; init; }

    /// <summary>Dialog construction time; deliberate review time is never recorded here.</summary>
    internal TimeSpan PreviewPreparationDuration { get; init; }
    ...
    public RestorePlan Redact() => this with
    {
        ...
        LayoutVariantId = LayoutVariantId is null ? null : RedactIdentifier(LayoutVariantId),
        LayoutVariantName = LayoutVariantName is null ? null : LogRedactor.RedactValue(
            LayoutVariantName,
            LogSensitivity.WorkspaceName,
            LogRedactionMode.Redacted),
